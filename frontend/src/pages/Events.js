  ...
  render () {
    ...
    return (
      <React.Fragment>
        ...
        {this.state.selectedEvent && <Modal title={this.state.selectedEvent.title} canCancel="true" canConfirm="true" onCancel={this.modalCancelHandler} onConfirm={this.bookEventHandler} confirmText="Book">
